...
//     this.name = name;  // Assign parameter to class variable
//     this.roll = roll;  // Assign parameter to class variable
// }

// /*
// Explanation:
// - Constructor name must match class name: Student
// - Parameters received: name and roll
// - 'this' keyword differentiates class variables from parameters
// - This is one of the most common Java interview questions for object creation
// */
// }
...
//     return a + b + c;  // Return sum of three integers
// }

// /*
// Explanation:
// - Two methods have same name 'add'
// - First adds two numbers, second adds three numbers
// - Java decides which method to run based on the number of inputs
// - Method overloading makes programs flexible and easier to understand
// - This is one of the most asked beginner Java interview topics
// */
// }
...
// - If not, checks if number is negative
// - Else, it must be zero
// - Nested if-else allows precise control over decisions
// - This is a core coding logic taught in every interview preparation
// */
// sc.close();
//     }
// }
...
// - At the end, sum holds total of all numbers from 1 to n
// */
...
// /*
// Explanation:
// - Loop processes each number in array
// - If number is positive, add to sum
// - If number is negative, increase counter
// - At the end, program prints both results
// - This task combines arrays, loops, and conditions in one structured solution
// */
